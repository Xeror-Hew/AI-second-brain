...
Get oriented, read-only. Read in this order:

1. `project_brain/next_step.md` for the active item.
2. `project_brain/roadmap/roadmap.md` for the current front and blockers.
3. For context: `project_brain/plan/plan_summary.md`.
4. Before touching the work: `project_brain/work_map/map_index.md`.
