...
Writing a skill is test-driven, applied to process documentation. Write the test (pressure scenario with a subagent), watch it fail (baseline behavior with no skill), write the skill, watch it pass, refactor to close loopholes.
...
- Good: `**REQUIRED:** Use /draft` / `**BACKGROUND:** understand /diagnose`
- Bad: `@skills/.../SKILL.md`
