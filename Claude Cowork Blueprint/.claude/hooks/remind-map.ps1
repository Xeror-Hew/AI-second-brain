...
# After a work file (a deliverable, not a project_brain doc) gets edited, inject a reminder
# (does NOT block): close out the task with /done if it's finished, and update the work map
...
try {
    ...
    # Work files only: skip .md and anything in the managed/infra folders.
